...
public class ConvenientBannerLocalPageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_convenient_banner_local_page);
        initViews();
        init();
    }
    ...
    private void init() {
        loadTestDatas();
        initWay();
        tv_page_num.setText(clickPosition+1+"/"+localImages.size());
        //本地图片例子
