...
public class ConvenientBannerNetPageActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_convenient_banner_net_page);
        initViews();
        init();
    }
    ...
    private void init() {
        ...
        tv_page_num.setText(clickPosition+1+"/"+networkImages.size());
