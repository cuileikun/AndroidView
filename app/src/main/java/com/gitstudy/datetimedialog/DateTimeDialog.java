...
public class DateTimeDialog extends AlertDialog implements OnDateChangedListener,OnTimeChangedListener {
	...
	public DateTimeDialog(Context context, int theme , String initDateTime, String errorInfo, final DateTimeSetListener listener) {
		...
		View view = inflater.inflate(com.qk.applibrary.R.layout.common_datetime, null);
		setView(view);
		Button setBt = (Button)view.findViewById(com.qk.applibrary.R.id.set_bt);
		Button cancelBt = (Button)view.findViewById(com.qk.applibrary.R.id.cancel_bt);
		...
		dateTv = (TextView)view.findViewById(com.qk.applibrary.R.id.date_tv);
		this.initDateTime = initDateTime;
		datePicker = (DatePicker)view.findViewById(com.qk.applibrary.R.id.datepicker);
		timePicker = (TimePicker) view.findViewById(com.qk.applibrary.R.id.timepicker);
	...
	private void resizePikcer(FrameLayout tp){
		...
		int spaceing = 5*((int)getContext().getResources().getDimension(com.qk.applibrary.R.dimen.dimen_5_dip))+
				(int)getContext().getResources().getDimension(com.qk.applibrary.R.dimen.dimen_60_dip);
...
//					}
	...
	private void resizeNumberPicker(NumberPicker np,int columnWidth){
		...
		params.setMargins((int) getContext().getResources().getDimension(com.qk.applibrary.R.dimen.dimen_5_dip), 0, 0, 0);
