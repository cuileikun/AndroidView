...
public class TabHostSecondActivity extends AppCompatActivity {
    ...
    private int[] mUnImgIds = {R.drawable.ren_wu_unselected, R.drawable.xiao_xi_unselected, R.drawable.men_hu_unselected, R.drawable.men_hu_unselected, R.drawable.bao_jiao_unselected};
    private int[] mImgIds = {R.drawable.ren_wu_selected, R.drawable.xiao_xi_selected, R.drawable.men_hu_selected, R.drawable.men_hu_selected, R.drawable.bao_jiao_selected};
    private String mUserTyp = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fragment_host_sec);
        initData();
    }
