 ...
 * 时间： 2016/9/12.
 */
public class RecycleDelDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycle_del_demo);
        ...
        mAdapter.setOnDelListener(new FullDelDemoAdapter.onSwipeListener() {
            ...
            public void onDel(int pos) {
                if (pos >= 0 && pos < mDatas.size()) {
                    Toast.makeText(RecycleDelDemoActivity.this, "删除:" + pos, Toast.LENGTH_SHORT).show();
                    mDatas.remove(pos);
