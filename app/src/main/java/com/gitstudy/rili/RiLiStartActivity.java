...
import com.gitstudy.rili.colorful.ColorfulActivity;
import com.gitstudy.rili.custom.CustomActivity;
import com.gitstudy.rili.index.IndexActivity;
import com.gitstudy.rili.liarbry.Calendar;
import com.gitstudy.rili.liarbry.CalendarLayout;
import com.gitstudy.rili.liarbry.CalendarView;
import com.gitstudy.rili.meizu.MeiZuActivity;
import com.gitstudy.rili.meizu.MeiZuMonthView;
import com.gitstudy.rili.meizu.MeizuWeekView;
import com.gitstudy.rili.pager.ViewPagerActivity;
import com.gitstudy.rili.progress.ProgressActivity;
import com.gitstudy.rili.range.RangeActivity;
import com.gitstudy.rili.simple.SimpleActivity;
import com.gitstudy.rili.single.SingleActivity;
import com.gitstudy.rili.solay.SolarActivity;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class RiLiStartActivity extends CvBaseActivity implements
    ...
    protected int getLayoutId() {
        return R.layout.cv_activity_main;
    }
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_more).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMoreDialog == null) {
                    mMoreDialog = new AlertDialog.Builder(RiLiStartActivity.this)
                            .setTitle(R.string.list_dialog_title)
                            .setItems(R.array.list_dialog_items, RiLiStartActivity.this)
                            .create();
                }
                mMoreDialog.show();
            }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            ...
                            case 6:
                                ...
                                new AlertDialog.Builder(RiLiStartActivity.this)
        ...
        findViewById(R.id.iv_func).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFuncDialog == null) {
                    mFuncDialog = new AlertDialog.Builder(RiLiStartActivity.this)
